...
class SimpleParam : public rclcpp::Node{
    ...
    public: 
        SimpleParam() : Node("simple_param"){
            ...
            declare_parameter<std::string>("simple_string_param", "Julius");

            param_callback_handle_ = add_on_set_parameters_callback(std::bind(&SimpleParam::paramChangeCallback, this, _1));
        }
